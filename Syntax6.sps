...
USE ALL.
COMPUTE filter_$=(missing < 1).
VARIABLE LABELS filter_$ 'missing < 1 (FILTER)'.
...
USE ALL.
COMPUTE filter_$=(outlier_p>0.001).
VARIABLE LABELS filter_$ 'outlier_p>0.001 (FILTER)'.
VALUE LABELS filter_$ 0 'Not Selected' 1 'Selected'.
FORMATS filter_$ (f1.0).
FILTER BY filter_$.
EXECUTE.
...
save results /outfile= 'C:\Users\alise\OneDrive\Desktop\uni\simm32\screedata.sav' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= 'C:\Users\alise\OneDrive\Desktop\uni\simm32\screedata.sav'.
TSPLOT VARIABLES= rawdata means percntyl /ID= root /NOLOG.


FACTOR
  /VARIABLES ar1 ar2 ar4 ar5 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar23 ar24 
    ar26 ar27
  /MISSING LISTWISE 
  /ANALYSIS ar1 ar2 ar4 ar5 ar7 ar9 ar10 ar11 ar12 ar13 ar15 ar17 ar18 ar19 ar20 ar21 ar23 ar24 
    ar26 ar27
  /PRINT UNIVARIATE INITIAL KMO EXTRACTION
  /PLOT EIGEN
  /CRITERIA MINEIGEN(1) ITERATE(25)
